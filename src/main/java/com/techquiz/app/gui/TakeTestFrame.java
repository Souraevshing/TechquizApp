...
import com.techquiz.app.dao.PerformanceDAO;
import com.techquiz.app.dao.QuestionsDAO;
import com.techquiz.app.pojo.*;
...
public class TakeTestFrame extends javax.swing.JFrame {
    ...
    public TakeTestFrame() {
        ...
        ImageIcon imageIcon = new ImageIcon("/Users/codey/Desktop/TechquizApp/src/main/resources/assets/luck.png");
    ...
    private void initComponents() {
        ...
        jrOption1.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrOption1);
        jrOption1.setFont(new Font("Quicksand", 1, 14)); // NOI18N
        jrOption1.setForeground(new Color(255, 255, 255));
        jrOption1.setText("jRadioButton1");

        jrOption3.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrOption3);
        jrOption3.setFont(new Font("Quicksand", 1, 14)); // NOI18N
        jrOption3.setForeground(new Color(255, 255, 255));
        jrOption3.setText("jRadioButton2");

        jrOption2.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrOption2);
        jrOption2.setFont(new Font("Quicksand", 1, 14)); // NOI18N
        jrOption2.setForeground(new Color(255, 255, 255));
        jrOption2.setText("jRadioButton3");

        jrOption4.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrOption4);
        jrOption4.setFont(new Font("Quicksand", 1, 14)); // NOI18N
        jrOption4.setForeground(new Color(255, 255, 255));
        jrOption4.setText("jRadioButton4");

        lblTimeCounter.setBackground(new Color(0, 0, 0));
        lblTimeCounter.setFont(new Font("Ayuthaya", 1, 18)); // NOI18N
        lblTimeCounter.setForeground(new Color(255, 255, 255));
