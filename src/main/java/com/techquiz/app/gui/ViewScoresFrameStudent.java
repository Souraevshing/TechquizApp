...
public class ViewScoresFrameStudent extends javax.swing.JFrame {
     ...
     */
    String examId;
    ArrayList<String> availableExamId;
    public ViewScoresFrameStudent() {
        initComponents();
        ImageIcon imageIcon = new ImageIcon("/Users/codey/Desktop/TechquizApp/src/main/resources/assets/health-report.png");
        jlblImage.setIcon(imageIcon);
        setLocationRelativeTo(null);
        lblUserName.setText("Hello "+ UserProfile.getUserName());
        txtStudent.setText(UserProfile.getUserName());
        try{
            availableExamId = PerformanceDAO.getAllExamId(UserProfile.getUserName());
            for (String subject : availableExamId){
                jcExamId.addItem(subject);
            }
    ...
    private void initComponents() {
        ...
        txtPercentage.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        ...
        txtLanguage.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        ...
        txtStudent.setFont(new Font("Quicksand", 1, 18)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(35, 35, 35)
                                .addComponent(txtStudent, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtPercentage, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addGap(50, 50, 50))
        );
    ...
    private boolean validateInput(){
        int selectedIndex = jcExamId.getSelectedIndex();
        if (selectedIndex == 0){
            return false;
        }
    ...
    private void jcExamIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcExamIdActionPerformed
        ...
        try{
            ...
            txtLanguage.setText("");
            Performance performance = PerformanceDAO.getDetails(examId, UserProfile.getUserName());
