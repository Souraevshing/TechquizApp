...
public class AdminOptionsFrame extends javax.swing.JFrame {
    ...
    public AdminOptionsFrame() {
        initComponents();
        ImageIcon imageIcon = new ImageIcon("/Users/codey/Desktop/TechquizApp/src/main/resources/assets/administrator.png");
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new Font("Quicksand", 1, 24)); // NOI18N
        jLabel1.setForeground(new Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("ONLINE QUIZ ADMINISTRATION PANEL");

        jLabel2.setBackground(new Color(0, 0, 0));
        jLabel2.setFont(new Font("Quicksand", 1, 20)); // NOI18N
        jLabel2.setForeground(new Color(255, 255, 255));
        jLabel2.setText("Make A Choice");

        jrSetPaper.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrSetPaper);
        jrSetPaper.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        jrSetPaper.setForeground(new Color(255, 255, 255));
        jrSetPaper.setText("Set A Paper");

        jrEditPaper.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrEditPaper);
        jrEditPaper.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        jrEditPaper.setForeground(new Color(255, 255, 255));
        jrEditPaper.setText("Edit Paper");

        jrRegisterStudent.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrRegisterStudent);
        jrRegisterStudent.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        jrRegisterStudent.setForeground(new Color(255, 255, 255));
        jrRegisterStudent.setText("Register Student");

        jrViewScore.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrViewScore);
        jrViewScore.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        jrViewScore.setForeground(new Color(255, 255, 255));
        jrViewScore.setText("View Scores");

        btnDoTask.setBackground(new Color(0, 0, 0));
        btnDoTask.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        btnDoTask.setForeground(new Color(255, 255, 255));
