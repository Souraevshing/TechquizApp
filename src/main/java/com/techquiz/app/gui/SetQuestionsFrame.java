...
import com.techquiz.app.dao.ExamDAO;
import com.techquiz.app.dao.QuestionsDAO;
...
public class SetQuestionsFrame extends javax.swing.JFrame {
    ...
    public SetQuestionsFrame() {
        initComponents();
        ImageIcon imageIcon = new ImageIcon("/Users/codey/Desktop/TechquizApp/src/main/resources/assets/to-do-list-3.png");
    ...
    private void initComponents() {
        ...
        lblTitle.setFont(new Font("Quicksand", 1, 26)); // NOI18N
        ...
        lblquestionNumber.setBackground(new Color(0, 0, 0));
        lblquestionNumber.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        ...
        btnDone.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        ...
        btnCancel.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        ...
        txtOption2.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        txtOption2.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        txtOption4.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        txtOption4.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        txtOption1.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        txtOption1.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        txtQuestion.setColumns(20);
        txtQuestion.setFont(new Font("Quicksand", 1, 18)); // NOI18N
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
       ...
       if (newExam.getTotalQuestions() == (questionStore.getCount())){
            ...
            disableAll();
            JOptionPane.showMessageDialog(null,"Questions Set Press Done to Continue ...","Successful",JOptionPane.INFORMATION_MESSAGE);
        }
        if (newExam.getTotalQuestions() > questionStore.getCount()){
            try{
                validateInputs();
                String correctAnswer = options.get(correctOption);
                    if (newExam.getTotalQuestions() > questionStore.getCount()){
                        ...
                        try {
                            ...
                            btnDone.setVisible(true);
                            disableAll();
                            JOptionPane.showMessageDialog(null,"Questions Set Press Done to Save in the DB ...","Successful",JOptionPane.INFORMATION_MESSAGE);
                        }
    ...
    private void btnDoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoneActionPerformed
        ...
        try{
            if (questionStore.getCount() == newExam.getTotalQuestions()){
                ...
                JOptionPane.showMessageDialog(null,"Please Add Total Number of Questions ","Information",JOptionPane.INFORMATION_MESSAGE);
            }
        }
