...
public class StudentOptionsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("/Users/codey/Desktop/TechquizApp/src/main/resources/assets/reading-2.png")); // NOI18N
        jLabel1.setText("jLabel1");

        jLabel2.setBackground(new Color(0, 0, 0));
        jLabel2.setFont(new Font("Quicksand", 1, 30)); // NOI18N
        jLabel2.setForeground(new Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("ONLINE QUIZ STUDENT PANEL");

        jLabel3.setBackground(new Color(0, 0, 0));
        jLabel3.setFont(new Font("Quicksand", 1, 24)); // NOI18N
        jLabel3.setForeground(new Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Make A Choice");

        jrTakeTest.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrTakeTest);
        jrTakeTest.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        jrTakeTest.setForeground(new Color(255, 255, 255));
        ...
        jrChangePassword.setBackground(new Color(0, 0, 0));
        buttonGroup1.add(jrChangePassword);
        jrChangePassword.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        jrChangePassword.setForeground(new Color(255, 255, 255));
        jrChangePassword.setText("Change Password");

        btnTask.setBackground(new Color(0, 0, 0));
        btnTask.setFont(new Font("Quicksand", 1, 18)); // NOI18N
        btnTask.setForeground(new Color(255, 255, 255));
